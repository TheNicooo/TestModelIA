...
import com.kauel.testmodelia.PrePostProcessor
import java.util.*
...
object PrePostProcessor {
    ...
    private const val mOutputColumn = 19 // left, top, right, bottom, score and 80 class probability
    ...
    fun outputsToNMSPredictions(
        ...
        for (i in 0 until mOutputRow) {
            if (outputs[i * mOutputColumn + 4] > mThreshold) {
                ...
                val rect = Rect((startX + ivScaleX * left).toInt(),
